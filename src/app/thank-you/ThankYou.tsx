...
const ThankYou = () => {
    ...
    const { configuration, BilingAddress, ShippingAddress, amount } = data
                ...
                <div className=" mt-10 border-t border-zinc-200">
                    <div className=" mt-10 flex flex-auto flex-col">
                        ...
                        <p className=" mt-2 text-sm text-zinc-600">
                            We at CaseMaker believe that a phone case doesn't only need to look good , but also last you for the years to come. We offer a 5-year print guarantee: If you case isn't of the highest quality,
                        ...
                        <div>
                            ...
                            <div className=" mt-2 text-zinc-700">
                                <address className=" not-italic">
                                    ...
                                    <span className=" block">
                                        {BilingAddress?.street}
                                    </span>
                                    <span className=" block">
                                        {BilingAddress?.city} {BilingAddress?.postalCode}
                                    </span>
