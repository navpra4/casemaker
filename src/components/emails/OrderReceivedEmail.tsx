...
const OrderReceivedemail = ({
    ...
    const baseUrl = process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : 'https://casemaker.vercel.app'
  return (
    <Html>
        <Head/>
            ...
            <Container style={container}>
                <Section style={message}>
                    ...
                    <Text style={global.text}>
                        We're preparing your delivery. Rest assured and it will be delievered in 2-3 days.
                    </Text>
                    <Text style={{...global.text, marginTop: 24}}>
                        If you have any questions regarding order, please feel free to contact us with your order number and we are ready to help.
                    </Text>
                </Section>
                <Hr style={global.hr}/>
